...
Many of the categories for the data I changed to . 


Below is a snippet of my data wrangling. This process was first executed in my exploration file and then streamlined into a function later.
...
### Alluvial graph 
A main challenge of this piece was balancing the visual elements. I decided to place the alluvial graph center since it takes up the most space and requires the most time to understand the findings. All surrounding graphs are included as additional information.

### Colors 
Much of the data was categorical and I originally had specific colors for each sampling environment (wastewater,. I decided to limit to six main colors for the plastic types I am using to tell this story in order to lead to less visual clutter as well as home in on the main theme of this piece.
