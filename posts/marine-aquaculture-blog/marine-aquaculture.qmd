...
In this study, I will use average annual sea surface temperature (SST) from 2008 to 2012. The data is from NOAA's Daily Global Satellite Sea Surface Temperature anomaly @NOAACoralReefWatch_SSTA.
...
In this study, I will use bathymetry data from the General Bathymetric Chart of the Oceans @GEBCO2022.
